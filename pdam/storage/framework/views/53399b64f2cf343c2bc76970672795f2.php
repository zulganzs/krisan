...
<?php $component->withAttributes([]); ?>
     <?php $__env->slot('header', null, []); ?> 
        <h2 class="font-semibold text-xl text-gray-800 dark:text-gray-200 leading-tight">
            <?php echo e(__('Ticket Details')); ?> #<?php echo e($complaint->id); ?>
                ...
                <div class="md:col-span-2 space-y-6">
                    <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                        <div class="p-6 text-gray-900 dark:text-gray-100">
                            <h3 class="text-lg font-semibold mb-4"><?php echo e($complaint->subject); ?></h3>
                            <div class="prose dark:prose-invert max-w-none">
                                <p class="whitespace-pre-wrap"><?php echo e($complaint->message); ?></p>
                            </div>
                            ...
                            <div class="mt-6 pt-6 border-t border-gray-200 dark:border-gray-700 flex justify-between text-sm text-gray-500 dark:text-gray-400">
                                <span>Category: <?php echo e(ucfirst(str_replace('_', ' ', $complaint->category))); ?></span>
                                <span>Submitted: <?php echo e($complaint->created_at->format('M d, Y H:i')); ?></span>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="space-y-6">
                    <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                        <div class="p-6 text-gray-900 dark:text-gray-100">
                            ...
                            <div class="space-y-2">
                                <p><span class="font-medium">Name:</span> <?php echo e($complaint->user->name); ?></p>
                                <p><span class="font-medium">Email:</span> <?php echo e($complaint->user->email); ?></p>
                                <p><span class="font-medium">Customer ID:</span> <?php echo e($complaint->user->customer_id ?? 'N/A'); ?></p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                        <div class="p-6 text-gray-900 dark:text-gray-100">
                            ...
                            <form action="<?php echo e(route('admin.complaints.update', $complaint)); ?>" method="POST">
                                <?php echo csrf_field(); ?>
...
<?php endif; ?>
                                    <select id="status" name="status" class="mt-1 block w-full border-gray-300 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300 focus:border-indigo-500 dark:focus:border-indigo-600 focus:ring-indigo-500 dark:focus:ring-indigo-600 rounded-md shadow-sm">
                                        <option value="open" <?php echo e($complaint->status === 'open' ? 'selected' : ''); ?>>Open</option>
...
<?php endif; ?>
                    ...
                    <div class="text-center">
                        <a href="<?php echo e(route('admin.complaints.index')); ?>" class="text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:hover:text-gray-100">
                            ← Back to Complaints
                        </a>
                    </div>
                </div>
...
<?php endif; ?>
<?php /**PATH C:\Users\omega\Desktop\krisan\pdam\resources\views/admin/complaints/show.blade.php ENDPATH**/ ?>