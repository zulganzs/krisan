            ...
            <?php if(isset($result)): ?>
                ...
                <div class="space-y-4">
                    ...
                    <div class="flex justify-between items-center pb-3 border-b border-sky-200 dark:border-sky-700">
                        ...
                        <span class="font-semibold text-gray-900 dark:text-white">Rp <?php echo e(number_format($result['water_cost'], 0, ',', '.')); ?></span>
                    </div>
                ...
                <div class="mt-6 p-4 bg-white dark:bg-gray-700 rounded-lg">
                    <p class="text-sm text-gray-600 dark:text-gray-400">
                        <strong><?php echo e(__('messages.formula')); ?>:</strong> Rp <?php echo e(number_format($result['water_cost'], 0, ',', '.')); ?> (Water) + Rp <?php echo e(number_format($result['admin_fee'], 0, ',', '.')); ?> (Admin)
                    </p>
                </div>
            <?php else: ?>
